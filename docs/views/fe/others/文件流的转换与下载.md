...
## 前言
说起文件，对于很多前后端初学者来讲，应该都是比较害怕的，对于文件流的概念，搞不清楚，有时候遇到问题也是不知道如何排除。下面我们来讲讲前端的文件处理
...
```
## 大文件上传 与 断点续传
- 大文件上传基本都是分片，blob提供的有个splice
- 断点续传：根据文件内容生成hash作为分片的名称，然后和服务端比对，上传过的不再上传。

参考这篇文章，讲的很清楚 ：https://juejin.im/post/6844904046436843527
